...
@Module({
  ...
  providers: [ProjectDeployService, ProjectDeployTraceService, GasTankTxLoggerService],
  exports: [ProjectDeployService, ProjectDeployTraceService, GasTankTxLoggerService],
})
