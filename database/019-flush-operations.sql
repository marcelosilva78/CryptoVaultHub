...
CREATE TABLE IF NOT EXISTS `flush_operations` (
  ...
  `total_amount` DECIMAL(65,0) NOT NULL DEFAULT 0,
  `succeeded_amount` DECIMAL(65,0) NOT NULL DEFAULT 0,
  `gas_cost_total` DECIMAL(65,0) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `flush_items` (
  ...
  `token_id` BIGINT NULL,
  `amount_before` DECIMAL(65,0) NULL,
  `amount_flushed` DECIMAL(65,0) NULL,
  `tx_hash` VARCHAR(66) NULL,
  `gas_cost` DECIMAL(65,0) NULL,
  `error_message` TEXT NULL,
