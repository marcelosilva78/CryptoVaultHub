...
CREATE TABLE IF NOT EXISTS `tiers` (
  ...
  `daily_withdrawal_limit_usd` DECIMAL(15,2) NOT NULL DEFAULT 10000.00,
...
CREATE TABLE IF NOT EXISTS `clients` (
  ...
  `tier_id`      BIGINT       NULL,
  `custody_mode` ENUM('full_custody','co_sign','client_initiated') NOT NULL DEFAULT 'full_custody',
