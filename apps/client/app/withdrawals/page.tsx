...
export default function WithdrawalsPage() {
  ...
  return (
    <div>
      <div className="text-[18px] font-bold mb-[18px]">Withdrawals</div>
      ...
      <div className="grid grid-cols-2 gap-3.5">
        ...
        <div className="bg-cvh-bg-secondary border border-cvh-border-subtle rounded-cvh-lg overflow-hidden">
          <div className="flex items-center justify-between px-[18px] py-[14px] border-b border-cvh-border-subtle">
            ...
            <button className="inline-flex items-center gap-1.5 px-2 py-[3px] rounded-[6px] font-display text-[10px] font-semibold cursor-pointer transition-colors bg-transparent text-cvh-text-secondary border border-cvh-border hover:border-cvh-text-secondary hover:text-cvh-text-primary">
              Export
            </button>
          </div>
          ...
          {addressBook.map((addr) => {
            ...
            return (
              <tr key={addr.address} className="hover:bg-cvh-bg-hover">
                ...
                <td className="px-[14px] py-2.5 border-b border-cvh-border-subtle font-mono text-[11px] text-cvh-accent">
                  {addr.address}
                </td>
