...
function AddChainModal({ onClose, onAdded }: AddChainModalProps) {
  ...
  return (
    <div className="fixed left-0 right-0 bottom-0 z-[200] flex items-start justify-center py-6 px-4 overflow-y-auto bg-black/60 backdrop-blur-sm" style={{ top: 56 }}>
      <div className="bg-surface-card border border-border-subtle rounded-modal shadow-float w-full max-w-[480px] mx-4 flex flex-col shrink-0">
