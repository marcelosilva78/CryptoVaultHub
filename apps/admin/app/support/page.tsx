...
const sections = [
  { title: "Knowledge Base", description: "Guias completos e tutoriais passo a passo para todos os módulos", href: "/support/kb", icon: BookOpen, accent: true },
  ...
  return (
    <div className="animate-fade-in max-w-3xl mx-auto py-12 px-6">
      <div className="text-center mb-10">
        ...
        <p className="text-body text-text-secondary">Encontre guias, tutoriais e respostas para suas dúvidas</p>
      </div>
