...
function getToken() {
  return typeof window !== "undefined" ? localStorage.getItem("cvh_admin_token") ?? "" : "";
}
...
function ProviderModal({ open, mode, initial, onClose, onSave }: ProviderModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-[200] flex items-center justify-center pt-14 bg-black/60 backdrop-blur-sm"
