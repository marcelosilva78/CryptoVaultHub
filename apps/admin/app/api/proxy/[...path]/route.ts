...
/**
 * Catch-all API proxy for admin portal.
...
async function handler(
  ...
  const token = request.cookies.get('cvh_admin_token')?.value;
  ...
  const backendRes = await fetch(`${ADMIN_API}${targetPath}${queryString}`, {
