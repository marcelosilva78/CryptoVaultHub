...
Generated from a successful homologation run on 2026-05-09.
...
**Endpoint:** `GET /projects/6998/gas-check`
...
**Endpoint:** `GET /projects/6998/deploy/status`
...
**Endpoint:** `GET /projects/6998/deploy/traces`
...
**Endpoint:** `GET /projects/6998/deploy/traces/56`
...
**Endpoint:** `GET /projects/6998/deletion-impact`
...
**Endpoint:** `GET /projects/6998/export`
...
**Endpoint:** `GET /wallets/56/balances`
...
**Endpoint:** `GET /gas-tanks/56/history?limit=10`
...
**Endpoint:** `GET /gas-tanks/56/topup-uri`
...
**Endpoint:** `GET /gas-tanks/56/alert-config`
...
**Endpoint:** `GET /deposit-addresses?page=1&limit=5`
...
**Endpoint:** `GET /deposits?page=1&limit=5`
...
**Endpoint:** `GET /withdrawals?page=1&limit=10`
...
**Endpoint:** `GET /addresses?page=1&limit=10`
...
**Endpoint:** `GET /address-groups?page=1&limit=10`
...
**Endpoint:** `GET /webhooks?page=1&limit=10`
...
**Endpoint:** `POST /webhooks/17/test`
...
**Endpoint:** `GET /webhooks/17/deliveries?page=1&limit=10`
...
**Endpoint:** `GET /webhooks/dead-letters?page=1&limit=10`
...
### Sample response (HTTP 400 — see notes)
```json
[
...
**Endpoint:** `GET /security/2fa-status`
...
**Endpoint:** `GET /security/shamir-shares`
...
**Endpoint:** `GET /knowledge-base/categories`
...
**Endpoint:** `GET /knowledge-base?page=1&limit=5`
...
**Endpoint:** `GET /deploy-traces?page=1&limit=5`
...
**Endpoint:** `GET /exports?page=1&limit=5`
