...
NEXT_PUBLIC_CLIENT_API_URL=http://localhost:8000/client
ENVEOF
...
echo -e "    HTTP:          ${GREEN}http://localhost:8000${NC}"
echo -e "    Admin API:     ${GREEN}http://localhost:8000/admin${NC}"
echo -e "    Client API:    ${GREEN}http://localhost:8000/client/v1${NC}"
echo -e "    Auth API:      ${GREEN}http://localhost:8000/auth${NC}"
echo ""
echo -e "  ${BOLD}Frontend Portals${NC}"
echo -e "    Admin Panel:   ${GREEN}http://localhost:3010${NC}"
echo -e "    Client Portal: ${GREEN}http://localhost:3011${NC}"
echo ""
echo -e "  ${BOLD}API Documentation (Swagger)${NC}"
echo -e "    Admin API:     ${GREEN}http://localhost:3001/api/docs${NC}"
echo -e "    Client API:    ${GREEN}http://localhost:3002/api/docs${NC}"
echo ""
...
echo -e "  Next steps:"
echo -e "  1. Configure RPC providers in the Admin Panel (http://localhost:3010)"
