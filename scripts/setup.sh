...
echo -e "  Next steps:"
echo -e "  1. Run SSL setup: ${CYAN}bash scripts/init-ssl.sh ${BASE_DOMAIN}${NC}"
echo -e "  2. Configure RPC providers in the Admin Panel (https://admin.${BASE_DOMAIN})"
echo -e "  3. Create your first client via Admin API"
